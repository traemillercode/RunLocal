...
const sections = [
  ...
  { eyebrow: "Stay in the loop", title: "A better local running conversation", body: "Forum posting and community discovery are planned. For now, browse the public preview and see what is taking shape." },
];
    ...
    <div className="marketing-page">
      ...
      <main id="top">
        ...
        <section id="preview" className="marketing-section marketing-preview" aria-labelledby="preview-title">
          <p className="marketing-kicker">Live preview</p><h2 id="preview-title">What’s happening in Columbia</h2>
          <p className="marketing-muted">Public event listings from the launch city. Seeded listings are clearly marked in the app.</p>
        ...
        <section className="marketing-split-section" aria-labelledby="tools-title"><div><p className="marketing-kicker">Bring your miles</p><h2 id="tools-title">Your calendar,<br />your choices.</h2><p>Strava is active today. Garmin, COROS, and Suunto integrations are coming soon.</p></div><div className="marketing-status-list"><div><strong>Strava</strong><span className="status-live">Active</span></div><div><strong>Garmin</strong><span>Coming soon</span></div><div><strong>COROS</strong><span>Coming soon</span></div><div><strong>Suunto</strong><span>Coming soon</span></div></div></section>
